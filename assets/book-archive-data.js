window.PAUL_BOOK_ARCHIVE = {
  ...
  "dailyPicks": [
    ...
    },
    {
      ...
      "review": "1900년 전후의 비엔나는 한 도시라기보다 감각의 압축 파일에 가깝다. 클림트와 분리파, 장식과 실내, 커피하우스와 정신분석이 같은 시간대에서 서로를 흔든다. 이 책은 미술 섹션과 책장 작업을 잇는 좋은 관문이다. 작품 하나를 설명하는 글에서 도시 전체의 시각 언어로 확장할 때, 우리가 어떤 식으로 이미지를 읽어야 하는지 보여줄 수 있다."
    },
    {
      "id": "392079279",
      "rank": 9,
