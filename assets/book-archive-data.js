  ...
  "dailyPicks": [
    {
      ...
      "subtitle": "원본은 왜 복제 이후에 더 어렵게 보이는가.",
      "review": "벤야민의 핵심은 복제가 예술을 단순히 값싸게 만드는 것이 아니라 지각과 정치의 조건을 바꾼다는 데 있다. 사진과 영화, 전시와 수용의 문제를 함께 읽고 싶을 때 여전히 가장 날카로운 출발점이다.",
    ...
    },
    {
      ...
      "sourcePage": 1,
      "reviewStatus": "우리 리뷰",
      "label": "Music Philosophy",
      "subtitle": "위대함은 왜 영웅담보다 형식의 긴장 속에 남는가.",
      "review": "아도르노는 베토벤을 삶의 신화로 미화하지 않고, 동기와 형식의 충돌 속에서 근대적 주체의 압력을 읽어 낸다. 음악을 듣는 귀를 철학의 문장으로 다시 훈련시키는 드문 책이다.",
    ...
    },
    {
      ...
      "reviewStatus": "우리 리뷰",
      "label": "Art History",
      "subtitle": "서양회화는 왜 어둠을 사실이 아니라 사유로 만들었는가.",
      "review": "스토이치타는 그림자를 명암의 부산물이 아니라 회화가 자기 한계를 드러내는 장치로 읽는다. 오늘의 이미지 노트와 함께 보면 빛과 침묵을 읽는 눈이 한층 정교해진다.",
